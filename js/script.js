...
const sectionIcons = { cursos: 'school', trilhas: 'signpost', canais: 'tv', pulses: 'campaign', eventos: 'event', grupos: 'groups', categorias: 'category', normativas: 'gavel', matriculas_cursos: 'school', matriculas_trilhas: 'signpost', matriculas_eventos: 'event' };
            ...
            <div style="display:flex;gap:32px;flex-wrap:wrap;align-items:flex-start;justify-content:flex-start;">
                <div style="display:flex;flex-direction:column;gap:24px;min-width:220px;">
                    <div class="logo-dropzone" id="dropzoneClaro">
                        ...
                        <div class="logo-preview" id="logoPreviewClaro" style="background:#fff;"><span class="material-icons-outlined" style="font-size:40px;color:#bbb;">upload_file</span></div>
                    ...
                    <div class="logo-dropzone" id="dropzoneEscuro">
                        ...
                        <div class="logo-preview" id="logoPreviewEscuro" style="background:#222;"><span class="material-icons-outlined" style="font-size:40px;color:#bbb;">upload_file</span></div>
                ...
                <div style="flex:1;min-width:320px;">
                    ...
                    <div style="margin-bottom:18px;">
                        ...
                        <div class="theme-selectors" style="display:flex;gap:18px;margin-top:10px;">
                            <button class="theme-btn active" data-theme="dark"><span class="material-icons-outlined">dark_mode</span> Dark</button>
                            <button class="theme-btn" data-theme="light"><span class="material-icons-outlined">light_mode</span> Light</button>
                            <button class="theme-btn" data-theme="system"><span class="material-icons-outlined">settings_brightness</span> Sistema</button>
                        </div>
                    </div>
            ...
            html += `<div class="integration-card">
                <div class="integration-card-header">
                    <div class="integration-card-info">
                        <div class="integration-card-logo">${card.logo ? `<img src='${card.logo}' style='width:40px;height:40px;object-fit:contain;border-radius:8px;'>` : `<span class="material-icons-outlined">extension</span>`}</div>
                        <div>
